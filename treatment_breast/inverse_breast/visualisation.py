...
from treatment_breast.inverse_breast.data_utils import load_nifti, load_mat
...
def visualize_solution_evolution(model, diff_slice, phi_slice, save_dir, config, gif_name="comparison.gif",
    ...
    # --- GIF ---
    with imageio.get_writer(f"{save_dir}/{gif_name}", mode='I', duration=500) as writer:
...
def plot_center_time_evolution_with_fdm(model, config, diff_slice, phi_slice, treatment_cfg,
    ...
    Produces a figure similar to the user's example but with both curves.
    """
...
# pff_volume = load_mat("/home/vanderhaeghen/research/isbi_pinn/data/phi.mat", 'phi') 
# diff_volume = load_mat("/home/vanderhaeghen/research/isbi_pinn/data/diff_map.mat", "diff_map")
# diff_slice = diff_volume[:, :, 7]
# phi_slice = pff_volume[:, :, 7]
# model = tf.keras.models.load_model("/home/vanderhaeghen/research/isbi_pinn_paper/inverse/results/arch_02_test_one_drug_5_days_greater_efficacy_bis/model.h5")
...
#     ic_y=0.0,
#     n_times=2000,
#     save_path="/home/vanderhaeghen/research/isbi_pinn_paper/inverse/results/arch_02_test_one_drug_5_days_greater_efficacy_bis/center_test_forward_final.png"
# )
...
# plt.title('Diffusion Map Slice')
# plt.colorbar(label='Diffusion Coefficient')
# plt.savefig("diffusion_map_slice2.png", dpi=500)
# plt.figure()
# plt.imshow(phi_slice, cmap='jet')
# plt.title('PFF Map Slice')
# plt.colorbar(label='PFF Coefficient')
# plt.savefig("pff_map_slice2.png", dpi=500)
# model = tf.keras.models.load_model("/home/vanderhaeghen/research/isbi_pinn_paper/inverse/results/arch_02_test_one_drug_5_days_greater_efficacy_bis/model.h5")
# visualize_solution_evolution(model, diff_slice, phi_slice, save_dir="/home/vanderhaeghen/research/isbi_pinn_paper/inverse/", gif_name="comparison_arch_02_with_one_treatment.gif",)