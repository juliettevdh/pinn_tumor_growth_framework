from treatment_breast.inverse_breast.main import run_experiment
...
EXPERIMENTS = [
    ...
    "D": 0.025, "r": 0.012, "radius": 0.30,
    "n_inside": 14000, "n_ic": 10000, "n_outside": 12000,
    "neurons": 32, "n_hidden_layers": 5, "actfn": "swish",
    "epochs":200000, "lr": 1e-3, "optimizer": "Adam", "batch_size": 512,
...
for exp in EXPERIMENTS:
    ...
    config = {
        ...
        "phi_slice_path": "/home/vanderhaeghen/research/isbi_pinn/data/phi.mat",
        "phi_slice_z": exp["phi_slice_z"],
        "diff_map_path": "/home/vanderhaeghen/research/isbi_pinn/data/diff_map.mat",
        "physics": {
            "D": exp["D"],
            "r": exp["r"],
            "nu": 0.45,
