import os
from glioblastoma.inverse_glioblastoma.train_inverse_batch import train_pinn
from glioblastoma.inverse_glioblastoma.data_utils_inverse import prepare_data
from glioblastoma.inverse_glioblastoma.visualisation import visualize_solution_evolution
from glioblastoma.inverse_glioblastoma.model import DNN_builder
...
def run_experiment(config):
    ...
    save_dir = os.path.join("results/final_test_centered", exp_id)
