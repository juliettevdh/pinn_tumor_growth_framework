...
def sample_collocation_points(n_points, x0, y0, rad, x_min=-1, x_max=1, y_min=-1, y_max=1, t_min=0, t_max=130):
...
def sample_anchors_outside_brain(n_points, phi_slice, t_max = 130):
...
def sample_initial_condition_points_in_domain(pff_slice,n_points, x0, y0, x_min=-1, x_max=1, y_min=-1, y_max=1, t_min=0, t_max=400):
